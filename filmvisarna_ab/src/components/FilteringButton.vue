        ...
        switch(this.type) {
          ...
          case "genre": {
            ...
            genres.forEach(genre => {
              contents.push({ menuOutput: genre, filter: genre })
            })
            break;
          }
          case "datum": {
              ...
              screenings.every(screening => { 
                if(date === this.dateAsString(screening.time)) {
                  ...
                  timeNow.getFullYear() === screening.time.getFullYear()
                    ...
                    contents.push({menuOutput: 'Idag', filter: screening.time});
                  } else if(
                  ...
                  screening.time.getFullYear() === tomorrow.getFullYear()
                    ...
                    contents.push({menuOutput: 'Imorgon', filter: screening.time});
                  } else {
                    contents.push({menuOutput: date, filter: screening.time})
                  }
                  return false;
                }
                return true;
